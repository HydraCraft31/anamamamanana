...
$sunucu_ismi = "Sunucu İsmi"; // Sunucu İsmini Girin //
$ip 		 = "play.SUNUCUİSMİ.co"; // Sunucu IP adresini Girin //
$surum 		 = "SUNUCU SÜRÜM"; // Sunucu Sürümünü Girin //


// Sayfa Başlığı ve Sayfa en başda duran logo //
$baslik 			= "MineTC » Kalitenin Adresi!"; // Sitenin Pencere bölümünde yazan yazı //
$aciklama 			= "MineTC Factions » Kalitenin Adresi! - play.minetc.com - 1.8.X"; // Google'da çıktığınızda sitenin açıklama kısmı //
...
$site_url 			= "http://oyunoynamaa.esy.es"; // Sitenizin URL'sini yazın sonunda / olmasın! //
...
date_default_timezone_set('Europe/Istanbul'); // Sunucunun Saatini Türkiye'ye Göre Ayarlıyoruz //
...
$resim1 = "http://minetc.com/img/slider_1.png"; // Sliderda Kayan 1. Resim //
$resim2 = "http://minetc.com/img/slider_2.png"; // Sliderda Kayan 2. Resim //
$resim3 = "http://minetc.com/img/slider_3.png"; // Sliderda Kayan 3. Resim //
$resim4 = "http://minetc.com/img/slider_4.png"; // Sliderda Kayan 4. Resim //
...
$bati_host_token = "token"; // BATIHOSTDAN ALDIĞINIZ TOKEN //
$batihost_id 	 = "111111"; // BATIHOST KULLANICI ID'NIZ //
$batihost_email  = "user@example.com"; // BATIHOST KULLANICI EMAIL'INIZ //


// SMTP AYARLARI //

$mail_adresi  = "noreply@minetc.com"; // SMTP MAİL ADRESİNİZ //
$mail_sifre	  = "erenkeremeren09*"; // SMTP MAİL ŞİFRENİZ //
$smtp_url	  = "cp1.rabisu.com"; // SMTP SUNUCUSU //
$smtp_port	  = "465"; // SMTP SUNUCU PORTU //
